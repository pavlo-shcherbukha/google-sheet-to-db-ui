<template>
	...
	<div class="card material-table" :style="{width: tableWidth ? tableWidth : 'auto'}">
		...
		<div class="table-footer">
			<p> {{ KeyField }}  S!!ecelted row={{ curentRow }} из {{rows.length}} Это footer грида </p>
...
<script>
   //import DataTable2 from '@/components/PvxDataTable/DataTable2.js';
	export default {
		props: {
			tableTitle: {
				type: String,
		...
		emits: ['rowchanged', 'dtb_updated'],
		data() {
			return {
				//datatablesrv: new DataTable2(),
				curentRow: 0,
